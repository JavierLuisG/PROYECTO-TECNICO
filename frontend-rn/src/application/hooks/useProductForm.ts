...
export function useProductForm({
  ...
  const handleChange = (name: keyof ProductFormValues, value: string) => {
    ...
    const fieldError = name !== 'date_revision' ? validateField(name, value) : '';
  ...
  const handleIdBlur = async () => {
    ...
    try {
      ...
      // Si el servicio falla, no bloqueamos
    }
  };
